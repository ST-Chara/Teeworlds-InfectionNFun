...
MACRO_CONFIG_INT(InfHeroAuraKills, inf_heroaurakills, 8, 0, 0, CFGFLAG_SERVER, "Kills needed for a heroaura.")
...
MACRO_CONFIG_STR(InfHeroAuraText, inf_HeroAura_text, 512, "Hero got %s a heroaura!", CFGFLAG_SERVER, "Text send when someone earns a heroaura (%s = player name)")
